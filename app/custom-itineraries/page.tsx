...
const Itineraries = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col text-accent animated-bg">
      <Navbar />
      <header className="mt-10 text-center py-8 text-accent mb-5">
        <h1 className="text-7xl text-primary">Create Custom Itineraries</h1>
        <p className="text-xl">
          Get tailor-made travel plans that suit your interests and budget.
        </p>
      </header>
